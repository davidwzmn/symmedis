        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 max-w-2xl text-[0.8125rem] leading-relaxed text-ink-2">
              Die wichtigsten diagnostischen Hebel werden nach Priorität und Reifegrad geordnet. Beleg, Ursache und Maßnahme bleiben direkt mit der jeweiligen Analysedimension verbunden.
            </p>
          </div>
            ...
            {nodes.map((eintrag, index) => {
                ...
                <>
                  ...
                  <div className="mt-3 flex items-center justify-between gap-2">
                    ...
                    <span className="text-xs font-medium text-brand-ink">
                      {onSelect ? 'Details öffnen →' : 'Im Detail unten'}
                    </span>
                  </div>
                </>
              )
              ...
              return (
                <div key={eintrag.kategorieId} className="relative pt-4 xl:pt-5">
                  ...
                  {onSelect ? (
                    <button type="button" onClick={() => onSelect(eintrag.kategorieId)} className={cardClass}>
                      {content}
                    </button>
                  ) : (
