...
import { ImpactModule } from '../../components/modules/ImpactModule.jsx'
...
export function ClientDetail() {
  ...
  return (
    <div className="space-y-6">
      ...
      {tab === 'impact' ? <ImpactModule kunde={kunde} /> : null}
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-5 lg:grid-cols-[1fr_20rem]">
        <div className="min-w-0 space-y-5">
          <section><h2 className="mb-3 text-base font-semibold text-ink">Die drei größten Umsatzbremsen</h2><BremsenCards kunde={kunde} /></section>
          <Card>
        ...
        <div className="min-w-0 space-y-5">
          ...
          <Card className="border-warn-border">
            ...
            <CardBody className="space-y-3">
              {kunde.notizenIntern.slice(0, 2).map((notiz) => <div key={notiz.id} className="rounded-lg border border-line bg-surface-muted p-3"><p className="text-[0.8125rem] leading-relaxed text-ink">{notiz.text}</p><p className="mt-1.5 text-xs text-ink-3">{notiz.autor}</p></div>)}
